  ...
  return (
    <section>
      ...
      <div>
        ...
        <div className="p-4 grid grid-cols-1 gap-4 sm:grid-cols-3 w-[90%] mx-auto">
          <div className="px-3 py-4 shadow-sm rounded-md">
            ...
            <p className="text-secondary mb-3 text-sm">Attempt quizzes in any preference of your selected choice</p>
          ...
          <div className="px-3 py-4 shadow-sm rounded-md">
            ...
            <p className="text-secondary mb-3 text-sm">Move up the ladder from Noob to GrandMaster as you take on our most challenging quiz</p>
            <p onClick={() => navigate("/login")} className="flex-start text-sm text-secondary cursor-pointer">
              Learn more
              <span className="ml-1"><FaArrowRight size={10} /></span>
            </p>
          ...
          <div className="px-3 py-4 shadow-sm rounded-md">
            ...
            <p className="text-secondary mb-3 text-sm">Earn a spot as part of the leading candidates among top users</p>
            <p onClick={() => navigate("/login")} className="flex-start text-sm text-secondary cursor-pointer">
              Learn more
              <span className="ml-1"><FaArrowRight size={10} /></span>
            </p>
        ...
        <div className="overflow-hidden whitespace-nowrap w-full max-h-100 p-3">
          <div className="inline-block animate-scroll">
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-md flex-shrink-0">
              ...
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">explore the world of science and the latest in technology</p>
            </div>
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-sm flex-shrink-0">
              ...
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">Celebrate creativity through painting, music, literature and expression</p>
            </div>
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-sm flex-shrink-0">
              <img src={history} className="h-[200px] mx-auto mb-2" />
              <h2 className="text-xl font-inter">History</h2>
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">Take a deep dive into the past and and uncover the events that shaped the world</p>
            </div>
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-sm flex-shrink-0">
              <img src={mythology} className="h-[200px] mx-auto mb-2" />
              <h2 className="text-xl font-inter">Mythology</h2>
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">Explore ancients legends, gods and mythical tales from every culture</p>
            </div>
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-sm flex-shrink-0">
              <img src={anime} className="h-[200px] mx-auto mb-2" />            
              <h2 className="text-xl font-inter">Anime & Manga</h2>
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">Enter the vibrant world of anime stories, characters and fan culture</p>
            </div>
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-sm flex-shrink-0">
              <img src={computers} className="h-[195px] mx-auto mb-3" /> 
              <h2 className="text-xl font-inter">Tech & Computers</h2>
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">Understand the digital world from hardware to software and beyound</p>
            </div>
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-sm flex-shrink-0">
              <img src={sports} className="h-[200px] mx-auto mb-2" /> 
              <h2 className="text-xl font-inter">Sports</h2>
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">Catch the thrill, passion and stories behind every game and athlete</p>
            </div>
            <div className="inline-block min-w-[200px] max-w-xs mx-2 p-3 shadow-sm rounded-sm flex-shrink-0">
              <img src={politics} className="h-[200px] mx-auto mb-2" /> 
              <h2 className="text-xl font-inter">Politics</h2>
              <p className="text-secondary mb-3 break-words whitespace-normal text-sm">Stay informed with the global issues, leaders and power dynamics</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-thinBlack text-white py-8 px-4 sm:flex-center flex-col mt-6">
        ...
        <p className="text-accentLight mb-4 sm:text-center">Join hundreds of users who challenge themselves daily with our quizzes. Sign up for free and start playing!</p>
